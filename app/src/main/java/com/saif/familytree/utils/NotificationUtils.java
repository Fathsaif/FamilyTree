...
import com.saif.familytree.core.constants.FirebaseConstants;

import java.util.List;

/**
 * Created by ganna on 2/1/2017
 */
...
public class NotificationUtils {
    ...
    private void showSmallNotification(NotificationCompat.Builder mBuilder, String title, String message, PendingIntent resultPendingIntent, Uri alarmSound) {
        ...
        mBuilder.setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.ic_launcher_round));
