...
public class PrefsUtil {
    ...
    private static final String DEFAULT_APP_PREFS_NAME = "hicoach-default-prefs";

    private static SharedPreferences getPrefs(String prefsName) {
        if (TextUtils.isEmpty(prefsName))
            prefsName = DEFAULT_APP_PREFS_NAME;
        return FamilyTreeApplication.get().getSharedPreferences(prefsName, Context.MODE_PRIVATE);
    }
