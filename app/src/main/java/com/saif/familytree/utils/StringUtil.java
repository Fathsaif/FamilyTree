...
public abstract class StringUtil {
    ...
    public static String getStringRes(@StringRes int stringRes) {
        return FamilyTreeApplication.get().getString(stringRes);
    }

    public static String getStringRes(@StringRes int stringRes, Object... formatArgs) {
        return FamilyTreeApplication.get().getString(stringRes, formatArgs);
    }
    ...
    public static void clearFeilds(EditText... ets) {
        for (EditText et :
                ets) {
            et.setText("");
        }
