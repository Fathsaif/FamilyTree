 ...
 * 
 *
 * Created by ganna on 27/04/2016 12.05.
 */
public class VolleyMultipartRequest extends Request<JSONObject> {
    ...
    private  Map<String, DataPart> mDataParams;
     ...
     */
    public VolleyMultipartRequest(int method, String url,HashMap<String, String> stringParams
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        try {
            ...
            LoggerUtil.d("BODY",new String(bos.toByteArray()));
  ...
  /*  @Override
    ...
    protected Map<String, DataPart> getByteData() throws AuthFailureError {
        for (Map.Entry<String, DataPart> entry : mDataParams.entrySet()) {
            String key = entry.getKey();
            DataPart value = entry.getValue();
            LoggerUtil.d("DATA_PARAMS : "+key+" , "+new String(value.getContent()));
        }
        return mDataParams;
    }
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
        LoggerUtil.d("parseNetworkResponse CALLED");
        try {
            ...
            LoggerUtil.e("UnsupportedEncodingException",e.getLocalizedMessage());
            return Response.error(new ParseError(e));
        } catch (JSONException je) {
            LoggerUtil.e("je",je.getLocalizedMessage());
    ...
    protected void deliverResponse(JSONObject response) {
        LoggerUtil.d("deliverResponse CALLED");
        ...
        if (baseDto.getApiStatus().equals(ErrorCodes.ServerCodes.FAILURE_RESPONSE_CODE) &&
            ...
            mErrorListener.onErrorResponse(new VolleyError(String.valueOf(ErrorCodes.API_KEY_NOT_VALID)));
        } else {
    ...
    protected Map<String, String> getParams() throws AuthFailureError {
        LoggerUtil.d("STRING_PARAMS : "+mStringParams.toString());
